...
- **Walk in with:** see the [README](README.md).
...
- **Walk out with:** a "Tell me about yourself" delivered out loud, a pipeline narrated to a peer, and `docs/interview-prep-notes.md` committed to your portfolio repo.
...
| 06 | Pair full mock (20 min) | 7-minute hot seat each: "Tell me about yourself" + project + KB demo + follow-ups using Practice Prompt 05.e |
| 07 | KB live-fire and cheat sheet (15 min) | Run Practice Prompt 05.f against your wiki, fix what's broken, commit `docs/interview-prep-notes.md` |
...
- **05.f** KB demo dry run — Part 07
- **05.g** Defensibility cheat sheet — Part 07

## What you commit by end of class

`docs/interview-prep-notes.md` in your portfolio repo: 6–10 bullets, one per component you can defend, in the format `<component>: <path> — <description>`. See study guide section 06 for the contract format. Show the instructor your commit hash on your way out — this is the participation evidence.
