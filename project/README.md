...
| 11 | Knowledge base | 10 | Use Claude Code to ingest your scraped sources into a `knowledge/` folder. At least 15 raw sources from 3+ different sites/authors in `knowledge/raw/`. Claude Code-generated wiki pages in `knowledge/wiki/` (overview, key entities, themes), and an `index.md`. |
