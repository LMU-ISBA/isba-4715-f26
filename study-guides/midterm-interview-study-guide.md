...
**Scheduling:** [https://calendly.com/greg-lontok/sql-midterm-interview](https://calendly.com/greg-lontok/sql-midterm-interview)
...
The interview will be conducted over **Zoom** at [https://lmula.zoom.us/my/lontok](https://lmula.zoom.us/my/lontok). You will use **DBeaver** (the same desktop SQL client from class) connected to the `basket_craft` database.

**Before your interview:**

1. Open DBeaver and verify you can connect to the `basket_craft` database
2. Join the Zoom meeting 2-3 minutes early: [https://lmula.zoom.us/my/lontok](https://lmula.zoom.us/my/lontok)
