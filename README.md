...
Welcome to ISBA 4715! In this course, you'll learn to use SQL for data exploration, analysis, and building business applications.
...
We use the **Campus Bites** case study — a campus food delivery service — to learn SQL through real business scenarios.
...
- **Data Analyst Skills**: Use SQL to explore and analyze data
- **Data Engineering**: Extract, transform, and load data with modern tools
- **Data Communication**: Present findings to technical and non-technical audiences
